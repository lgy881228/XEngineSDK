...
- (TabBarController *)createTabBarController
{
    ...
    RecyleWebViewController *webVC0 = [[RecyleWebViewController alloc] initWithMicroAppId:@"com.zkty.xiaoqu.network" microAppVersion:@"0" index:0];
    RecyleWebViewController *webVC1 = [[RecyleWebViewController alloc] initWithMicroAppId:@"com.zkty.xiaoqu.nav" microAppVersion:@"0" index:0];
    RecyleWebViewController *webVC2 = [[RecyleWebViewController alloc] initWithMicroAppId:@"com.zkty.xiaoqu.network" microAppVersion:@"0" index:0];
...
//    tabVC.tabBar.translucent = NO;
    ...
    tabVC.tabBarItemSelectedImages = @[[UIImage imageNamed:@"tabbar_home_select"],
                                       ...
                                       [UIImage imageNamed:@"tabbar_mine_select"]
                                        ];

    tabVC.contentViewControllers = @[webVC0,webVC1,webVC2];
